...
public class GroupStatsTable {
  ...
  public DatabaseTableConfig<GroupProfile> getDatabaseTableConfig(String group) {
    ...
    return new DatabaseTableConfig<>(GroupProfile.class, "groupstats-" + group,
        Arrays.asList(uuid, gamesPlayed, bedsBroken, bedsLost, kills, deaths, finalKills,
            finalDeaths, wins, losses, winstreak, highestWinstreak));
  }
}
